...
class TesteMotoca(unittest.TestCase):
    ...
    def testSubidaMotocaCheia(self):
        ...
        pessoa = Pessoa("João", 5)
        motoca.subir(pessoa)
        self.assertFalse(motoca.subir(Pessoa("Maria", 3)),
    ...
    def testDescerMotocaVazia(self):
        motoca = Motoca(5)
        self.assertFalse(motoca.descer(),
    ...
    def testDirgirSemPiloto(self):
        motoca = Motoca(5)
        self.assertFalse(motoca.dirigir(5),
    ...
    def testAdicionandoTempoNegativo(self):
        ...
        self.assertEqual(10, motoca.getTempo(),
                         "A quantidade de tempo nao deve ser alterada apos uma operacao invalida")
    ...
    def testDirgirComTempoSobrando(self):
        ...
        self.assertEqual(pessoa, motoca.getPessoa(), "A pessoa dirigindo nao e a mesma que subiu")
        self.assertTrue(motoca.dirigir(10),
